...
export default function App() {
  ...
  const activities: { title: string; icon: string; svg: string; w: number; h: number; url?: string; target?: string; category: string }[] = [
    ...
    },
    {
      ...
      w: 220,
      h: 140,
      url: 'https://view.genially.com/65a7e7a4005d900013fd28b5/',
      category: 'Géométrie',
    ...
    },
    {
      ...
      w: 220,
      h: 140,
      url: 'https://mathup.fr/cours/primaire/ce1/geometrie-figures-planes.html',
      category: 'Géométrie',
        ...
        <>
          ...
          <div className={`hidden lg:flex fixed top-[76px] bottom-[90px] right-4 w-[300px] z-30 flex-col gap-4 p-4 rounded-[20px] backdrop-blur-xl border shadow-[0_8px_28px_rgba(0,0,0,0.28)] overflow-auto ${isLight ? 'bg-white/92 border-slate-200' : 'bg-[rgba(15,23,42,0.92)] border-white/10'}`}>
            ...
            <div>
              ...
              <div className="flex flex-col gap-2">
                <button onClick={() => window.open('https://mathsdys.org', '_blank', 'noopener,noreferrer')} className={`w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-[13px] font-bold border ${isLight ? 'bg-white border-slate-200 hover:bg-slate-50 text-slate-700' : 'bg-white/[0.06] border-white/10 hover:bg-white/[0.10] text-white'}`}>
